...
public class BinanceComExchange extends BinanceExchange {
    ...
    static {
        ...
        SUPPORTED_FIATS.add(FiatCurrency.USDC.getCode());
        SUPPORTED_FIATS.add(FiatCurrency.BUSD.getCode());
        SUPPORTED_FIATS.add(FiatCurrency.USDT.getCode());
        ...
        SUPPORTED_CRYPTOS.add(CryptoCurrency.FTT.getCode());
        ...
        SUPPORTED_CRYPTOS.add(CryptoCurrency.YFI.getCode());
        SUPPORTED_CRYPTOS.add(CryptoCurrency.OMG.getCode());
        SUPPORTED_CRYPTOS.add(CryptoCurrency.XTZ.getCode());
    }
